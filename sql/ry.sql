...
-- ----------------------------
INSERT INTO `gen_table` VALUES ('2', 'jl_file', '文件管理', null, null, 'JlFile', 'crud', 'com.ruoyi.system', 'ruoyi-jl', 'file', '文件管理', 'HZL', '0', '/', '{}', 'admin', '2023-07-17 16:19:35', '', '2023-07-19 11:10:27', null);
...
-- ----------------------------
INSERT INTO `gen_table_column` VALUES ('9', '2', 'file_id', '文件ID', 'bigint', 'Long', 'fileId', '1', '1', null, '1', null, null, null, 'EQ', 'input', '', '1', 'admin', '2023-07-17 16:19:35', '', '2023-07-19 11:10:27');
INSERT INTO `gen_table_column` VALUES ('10', '2', 'file_name', '文件名', 'varchar(255)', 'String', 'fileName', '0', '0', '1', '1', '1', '1', '1', 'LIKE', 'input', '', '2', 'admin', '2023-07-17 16:19:35', '', '2023-07-19 11:10:27');
INSERT INTO `gen_table_column` VALUES ('11', '2', 'file_path', '文件路径', 'varchar(255)', 'String', 'filePath', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'input', '', '3', 'admin', '2023-07-17 16:19:35', '', '2023-07-19 11:10:27');
INSERT INTO `gen_table_column` VALUES ('12', '2', 'file_type', '文件类型', 'int', 'Long', 'fileType', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'select', 'file_type', '4', 'admin', '2023-07-17 16:19:35', '', '2023-07-19 11:10:27');
INSERT INTO `gen_table_column` VALUES ('13', '2', 'user_id', '用户ID', 'bigint', 'Long', 'userId', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'input', '', '5', 'admin', '2023-07-17 16:19:35', '', '2023-07-19 11:10:27');
INSERT INTO `gen_table_column` VALUES ('14', '2', 'dept_id', '部门ID', 'bigint', 'Long', 'deptId', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'input', '', '6', 'admin', '2023-07-17 16:19:35', '', '2023-07-19 11:10:27');
INSERT INTO `gen_table_column` VALUES ('15', '2', 'status', '文件状态', 'int', 'Long', 'status', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'radio', 'file_status', '7', 'admin', '2023-07-17 16:19:35', '', '2023-07-19 11:10:27');
INSERT INTO `gen_table_column` VALUES ('16', '2', 'create_time', '上传时间', 'datetime', 'Date', 'createTime', '0', '0', '1', '1', null, null, null, 'EQ', 'datetime', '', '8', 'admin', '2023-07-17 16:19:35', '', '2023-07-19 11:10:27');
...
INSERT INTO `sys_config` VALUES ('4', '账号自助-验证码开关', 'sys.account.captchaEnabled', 'true', 'Y', 'admin', '2023-07-17 15:13:35', '', null, '是否开启验证码功能（true开启，false关闭）');
...
CREATE TABLE `sys_menu` (
  ...
  PRIMARY KEY (`menu_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2013 DEFAULT CHARSET=utf8mb3 COMMENT='菜单权限表';
...
INSERT INTO `sys_menu` VALUES ('2006', '文件管理', '2012', '1', 'file', 'ruoyi-jl/file/index', null, '1', '0', 'C', '0', '0', 'ruoyi-jl:file:list', 'clipboard', 'admin', '2023-07-17 16:21:13', 'admin', '2023-07-19 15:14:46', '文件管理菜单');
...
INSERT INTO `sys_menu` VALUES ('2012', 'JL', '0', '5', 'ruoyi-jl/file', null, null, '1', '0', 'M', '0', '0', '', 'list', 'admin', '2023-07-19 15:13:39', 'admin', '2023-07-19 15:14:07', '');
...
) ENGINE=InnoDB AUTO_INCREMENT=187 DEFAULT CHARSET=utf8mb3 COMMENT='操作日志记录';
...
INSERT INTO `sys_role` VALUES ('2', '普通角色', 'common', '2', '2', '1', '1', '0', '0', 'admin', '2023-07-17 15:13:35', 'admin', '2023-07-19 16:25:36', '普通角色');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', '200', 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2023-07-19 17:49:33', 'admin', '2023-07-17 15:13:35', '', '2023-07-19 17:49:32', '管理员');
...
INSERT INTO `sys_user` VALUES ('100', '201', '17633333114', '胡子龙', '00', '', '17633333114', '0', '', '$2a$10$yfP8cPObo7EDVoXahzHvDubKQFNUP6.kTXtF8tPZX92r9odChwCZi', '0', '0', '127.0.0.1', '2023-07-19 16:25:47', 'admin', '2023-07-18 09:03:18', 'admin', '2023-07-19 16:25:47', null);
